# USAGE
# python FaceRecognitionT.py --cascade haarcascade_frontalface_default.xml --encodings encodings.pickle                                
...
image_hub = imagezmq.ImageHub(open_port='tcp://127.0.0.1:5560', REQ_REP=False)
