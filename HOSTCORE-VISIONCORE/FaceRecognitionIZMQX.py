...
while True:
    ...
    # Adds slight delay (greater at first but catches up)
    ...
    # HERE IS WHERE WE SEND THE DATA FOR FIGURING SERVO POSITION FOR FACE TRACKING!
    # Commented out for now for troubleshooting reasons
