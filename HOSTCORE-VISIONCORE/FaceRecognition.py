...
socketM.bind("tcp://192.168.1.202:5558")
time.sleep(2)
...
# ** START OF ADD ************************************************************************
                    ...
                    if threading.active_count() < 5:
                        print("Threading Activecount (in) = " + str(threading.active_count()))
            ...
            for ((top, right, bottom, left), name) in zip(boxes, names):
                ...
                if name == "Unknown":
                    ...
                    if framecount % 5 == 0:
                        if newName != "":
                            if dev == 1:
                                writeFrame = devFrame  # *SHOULD* be image without green rectangle.  But...
                            else:
                                writeFrame = frame
                            cv2.imwrite('/home/pi/Desktop/HOSTCORE/NEWFACES/' + newName + "/" + str(framecount) + '.jpg', writeFrame)
