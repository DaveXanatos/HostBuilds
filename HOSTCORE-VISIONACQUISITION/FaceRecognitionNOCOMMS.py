# USAGE
# python /home/pi/Desktop/HOSTCORE/FaceRecognitionNOCOMMS.py --cascade /home/pi/Desktop/HOSTCORE/haarcascade_frontalface_default.xml --encodings /home/pi/Desktop/HOSTCORE/encodings.pickle
...
while True:
    ...
    for encoding in encodings:
        ...
        if True in matches:
            ...
            if name not in greetedPeople:
                ...
                print(speakText)
                thread = Thread(target = set_voice, args = (speakText, ))  # This line actually speaks the text in a thread
                thread.start()
    ...
    # display the image to our screen.  When independently live (not needing SSH with screen for viewing) this can be disabled for speed.
