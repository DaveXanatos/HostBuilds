# USAGE
# python FaceRecognitionIZMQ.py --cascade haarcascade_frontalface_default.xml --encodings encodings.pickle
...
#vs = VideoStream(src=0).start()q
#vs = VideoStream(usePiCamera=True).start()
#time.sleep(2.0)
image_hub = imagezmq.ImageHub(open_port='tcp://192.168.1.210:5560', REQ_REP=False)

print(image_hub.zmq_socket.hwm)   # Should print 1000
image_hub.zmq_socket.disconnect('tcp://192.168.1.210:5560')
image_hub.zmq_socket.set_hwm(2)
print(image_hub.zmq_socket.hwm)   # Should print 2
image_hub.zmq_socket.connect('tcp://192.168.1.210:5560')
