...
def moveHead(rot,lel,rel,delay):
    pwm2.set_pwm(ROT, 0, rot) # Rot'n: 270 = Max Left, 650 = Max Right, 450 Center
    pwm2.set_pwm(LEV, 0, lel) # L Elev: 390 = Max Up, 530 = Max  Down, 440 Center
    pwm2.set_pwm(REV, 0, rel) # R Elev: 390 = Max Up, 200 = Max  Down, 350 Center
    time.sleep(delay)
...
jawSeq = [(25,.3),(10,.1),(60,.2),(80,.2),(50,.25),(100,1),(50,.25),(60,.1),(50,.1),(80,.1),(45,.1),(22,.35)]
thread = Thread(target = doJaw, args = (jawSeq,))
thread.start()
