...
vrc = 300  # Experimentally Determined Right Vertical Center Value (Lower = Lower) was 312
...
rotc = 470 # Neck Rotation Center?
ltec = 460 # Neck Left Elevator Center?
rtec = 295 # Neck Right Elevator Center?
...
# Neck:
#pwm2.set_pwm(ROT, 0, rotc) # Rot'n: 270 = Max Left, 650 = Max Right, 470 Center
#pwm2.set_pwm(REV, 0, rtec) # R Elev: 390 = Max Up, 200 = Max  Down, 295 Center
#pwm2.set_pwm(LEV, 0, ltec) # L Elev: 390 = Max Up, 530 = Max  Down, 460 Center
#time.sleep(.5)
